...
class medicareseeall8 extends StatefulWidget {
  const medicareseeall8({super.key});

  @override
  State<medicareseeall8> createState() => _medicareseeall8State();
}

class _medicareseeall8State extends State<medicareseeall8> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Topicure Pet Wound Healing Spray for Dogs and Cats of All Breeds, 75ml',style: TextStyle(
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text('₹254',style: TextStyle(
                        color: Colors.black,
                        fontFamily: 'Inter',
                        fontSize: 14,
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('All Natural and Safe Wound Healing Spray - Topicure Pet is made of all natural ingredients which helps in rapid healing of any kind of open wounds in Dogs, Cats, Puppies & Kittens Visible results - In just 2 applications per day within 3 days you are guaranteed to see visible results in wound healing Clinically Proven Results - Natural Remedies have conducted various levels of checks and has all clinical data to prove results. Non Irritant & Lick Safe - Topicure Pet is completely natural therefore if your pet licks the product on their skin after application it will not cause any harm. It also helps curb skin irritation to keep your pet calm. No Gas! No Sound! No Scare! - The spray is guaranteed to not scare away your pet since it is a non gas spray.',
                  style: TextStyle(
                      color: Colors.black,
                      fontFamily: 'AbhayaLibre',
                      fontSize: 16
