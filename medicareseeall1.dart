...
class medicareseeall1 extends StatefulWidget {
  const medicareseeall1({super.key});

  @override
  State<medicareseeall1> createState() => _medicareseeall1State();
}

class _medicareseeall1State extends State<medicareseeall1> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Praziquantel Pyrantel Pamoate & Febantel Tablets',style: TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Fenbendazole, praziquantel and pyrantel pamoate in dog plasma. The combination of these drugs is the most powerful treatment against most types of worms.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
