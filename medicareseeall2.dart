...
class medicareseeall2 extends StatefulWidget {
  const medicareseeall2({super.key});

  @override
  State<medicareseeall2> createState() => _medicareseeall2State();
}

class _medicareseeall2State extends State<medicareseeall2> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Virbac Ipraz Deworming Tablets Ivermectin And Praziquantel',style: TextStyle(
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text('₹107',style: TextStyle(
                        color: Colors.black,
                        fontFamily: 'Inter',
                        fontSize: 14,
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Worms are capable of harming the pet in many ways. Some of the symptoms are a weakness, listlessness, dry and dull fur, diarrhea, vomiting, lack of appetite, weight loss and improper growth Virbac’s dewormer for dogs is a safe and effective way to combat the menace of intestinal worms. it is extremely palatable and a small-sized tablet, thus improving compliance.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
