...
class medicareseeall5 extends StatefulWidget {
  const medicareseeall5({super.key});

  @override
  State<medicareseeall5> createState() => _medicareseeall5State();
}

class _medicareseeall5State extends State<medicareseeall5> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Marbomet marbofloxacin tablets for dogs',style: TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Marbormet tablets are indicated for the treatment of infections caused by gram-negative and gram-positive organisms in dogs',
                  style: TextStyle(
                      color: Colors.black,
                      fontFamily: 'AbhayaLibre',
                      fontSize: 16
