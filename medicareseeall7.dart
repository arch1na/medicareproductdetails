...
class medicareseeall7 extends StatefulWidget {
  const medicareseeall7({super.key});

  @override
  State<medicareseeall7> createState() => _medicareseeall7State();
}

class _medicareseeall7State extends State<medicareseeall7> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Royal Sigma Ambiflush Ear Cleanser for Dogs| Ear Cleansing Solution (100 ml)',style: TextStyle(
              ...
              //           child: Text('Medicine Type\n\nPhysical Form\nIngredients\nRecommended For\nStorage Instructions',style: TextStyle(
              //               color: Colors.black,
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('INTAS Ambiflush 100 ml is a high-quality ear cleanser for pets that treats moderate to ear infections in them. It is a medication that works for both dogs and cats. This ear cleanser also dissolves the excessive wax built-up that gets accumulated in the animal’s ears over a period of time. INTAS Ambiflush is one of the most recommended ear solutions by veterinarians for getting rid of smelly ears in pets too.',
                  style: TextStyle(
                      color: Colors.black,
                      fontFamily: 'AbhayaLibre',
                      fontSize: 16
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text(' Features:\n- For treatment of moderate to severe ear infections.\n- Cerumenolytic to dissolve excessive wax built-up.\n- Prevents ear infection and maintains a healthy ear.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text(' Directions to Use:\nApply liberally into the ear canal and gently rub the accessible portion of the ear. And clean the ear folds and inside of the ear pinna with sterile cotton balls.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text(' Precautions:\n1.Only for animal use.\n2.Not for human use.\n3.Keep out of reach of children.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
