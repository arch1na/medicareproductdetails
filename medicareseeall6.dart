...
class medicareseeall6 extends StatefulWidget {
  const medicareseeall6({super.key});

  @override
  State<medicareseeall6> createState() => _medicareseeall6State();
}

class _medicareseeall6State extends State<medicareseeall6> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Skyworm® Cat',style: TextStyle(
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text('₹355.00',style: TextStyle(
                        color: Colors.black,
                        fontFamily: 'Inter',
                        fontSize: 14,
              ...
              Padding(
                ...
                child: Text('Skyworm cat is a deworming tablet for cats containing Praziquantel and Pyrantel embonate. It is a broad spectrum dewormer which helps in the removal of tapeworm, hookworm and roundworm infestations in cats and kitten.',
                  style: TextStyle(
                      color: Colors.black,
                      fontFamily: 'AbhayaLibre',
                      fontSize: 16
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Deworming is an important preventive care regime for reducing the internal parasite load and it helps to improve the overall health and wellbeing of your pet',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Helps eliminate worm load in adult cats',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Effective against Tapeworm, Hookworm, & Roundworm',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('Directions for use:',style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  fontWeight: FontWeight.bold
                ),),
              ...
              Padding(
                ...
                child: Text('- Dosage: 1 tablet per 4 kg body weight',
                  style: TextStyle(
                      color: Colors.black,
                      fontFamily: 'AbhayaLibre',
                      fontSize: 16
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- The tablet can be given directly or mixed with the food',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
