...
class medicareseeall4 extends StatefulWidget {
  const medicareseeall4({super.key});

  @override
  State<medicareseeall4> createState() => _medicareseeall4State();
}

class _medicareseeall4State extends State<medicareseeall4> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('BEAPHAR WOREX SUSPENSION',style: TextStyle(
              ...
              Padding(
                ...
                child: Text('- Safe dose is efficient for effective treatment',
                  style: TextStyle(
                      color: Colors.black,
                      fontFamily: 'AbhayaLibre',
                      fontSize: 16
              ...
              Padding(
                ...
                child: Text('- To kill whipworms, hookworms, round worms',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Effective remedy to kill worms',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
